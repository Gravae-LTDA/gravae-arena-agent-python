...
def main():
    ...
    # Desliga detector_send_frames onde nao ha deteccao de movimento/objeto: evita
    # decode 1080p em software (CPU/calor) sem afetar gravacao por botao. Idempotente.
